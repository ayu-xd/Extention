(() => {
  ...
  e = (e, t) => {
    ...
    ((t.exports = o),
      (t.exports.once = function (a, u) {
        return new Promise(function (e, t) {
          ...
          var i, o, s;
          (d(a, u, r, { once: !0 }),
            "error" !== u && ((o = n), (s = { once: !0 }), "function" == typeof (i = a).on) && d(i, "error", o, s));
        });
      }),
    ...
    function l(e, t, n, r) {
      ...
      return (
        ...
        void 0 === (i = e._events)
          ...
          : (void 0 !== i.newListener && (e.emit("newListener", t, n.listener || n), (i = e._events)), (o = i[t])),
        void 0 === o
          ? ((o = i[t] = n), ++e._eventsCount)
          : ("function" == typeof o ? (o = i[t] = r ? [n, o] : [o, n]) : r ? o.unshift(n) : o.push(n),
            0 < (i = a(e)) &&
              o.length > i &&
              !o.warned &&
              ((o.warned = !0),
    ...
    (Object.defineProperty(o, "defaultMaxListeners", {
      ...
      (o.prototype.emit = function (e) {
        ...
        else for (var s = o.length, a = v(o, s), n = 0; n < s; ++n) u(a[n], this, t);
        return !0;
      }),
  ...
  var e,
    ...
    r = ((e, t, n) => {
      n = null != e ? a(p(e)) : {};
      var r = !t && e && e.__esModule ? n : u(n, "default", { value: e, enumerable: !0 }),
        i = e,
        o = void 0,
        s = void 0;
      if ((i && "object" == typeof i) || "function" == typeof i)
        for (let e of l(i))
          c.call(r, e) || e === o || u(r, e, { get: () => i[e], enumerable: !(s = f(i, e)) || s.enumerable });
      return r;
  ...
  var s = (() => {
    let t =
      "undefined" != typeof crypto ? crypto : "undefined" != typeof window ? window.crypto || window.msCrypto : void 0;
    if (void 0 !== t) {
    ...
    r = new (class extends r.EventEmitter {
      constructor(e) {
        (super(),
          ...
          (this.wall = e).listen((e) => {
            Array.isArray(e) ? e.forEach((e) => this._emit(e)) : this._emit(e);
          }),
          (this._sendingQueue = []),
          (this._sending = !1),
          (this._maxMessageSize = 33554432));
      }
      send(e, t) {
        return this._send([{ event: e, payload: t }]);
      }
      getEvents() {
        return this._events;
      }
      on(e, n) {
        return super.on(e, (t) => {
          n({ ...t, respond: (e) => this.send(t.eventResponseKey, e) });
        });
      }
      _emit(e) {
      ...
      _nextSend() {
        ...
        return new Promise((n, e) => {
          let r = [],
            i = (e) => {
              var t;
              void 0 !== e && e._chunkSplit
                ? ((t = e._chunkSplit), (r = [...r, ...e.data]), t.lastChunk && (this.off(p, i), n(r)))
                : (this.off(p, i), n(e));
            };
          this.on(p, i);
          try {
            var t = f.map((e) => ({ ...e, payload: { data: e.payload, eventResponseKey: p } }));
            this.wall.send(t);
          } catch (e) {
              ...
              if (t > this._maxMessageSize) {
                ...
                for (let e = 0; e < o; e++) {
                  ...
                  this.wall.send([
                    {
                      event: l.event,
                      payload: { _chunkSplit: { count: o, lastChunk: e === o - 1 }, data: a.splice(0, u) },
                    },
                  ]);
                }
              }
